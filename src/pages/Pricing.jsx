        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
          <div className="bg-black bg-opacity-40 w-80 rounded-xl p-6 flex flex-col items-center">
            ...
            <div className="page-breadcrumb">
              <a href="/" className="hover:underline">Home</a> / <span className='text-green-700'>Price</span>
            </div>
          </div>
        </div>
      </div>

      <h2 className="text-4xl font-bold mb-6 text-center"><span className='text-green-700'>Our</span> Price</h2>
