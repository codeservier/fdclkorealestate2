...
const Packages = () => {
 ...
 <div className="flex flex-col items-center text-center p-6 bg-gray-50">
      <div className="mb-4">
        <p className="text-lg font-semibold">Our Handcrafted Packages for you..</p>
      </div>
      <div className="mb-4">
    ...
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg">
      ...
      <AccordionItem title="Structure">
        <ul>
          ...
          <li>RCC Design Mix As per the structural designer’s recommendation</li>
      ...
      <AccordionItem title="Kitchen">
        <ul>
          <li>Ceramic Wall Tiles, 2 feet above kitchen slab – Upto Rs.40 per Sqft.</li>
      ...
      <AccordionItem title="Bathroom">
        <ul>
          <li>Bathroom Ceramic Wall Tiles with 7 feet height – Upto Rs.40 per Sqft</li>
          <li>Sanitary ware & CP Fittings – Upto Rs.30000 per 1000 sqft of construction</li>
          <li>CPVC Pipe – Astral or equivalent</li>
          <li>Bathroom Accessories – EWC, Health Faucet, Wash Basin with accessories, 2 in 1 wall mixer, Overhead Shower.</li>
          <li>Bathroom doors – WPVC Waterproof doors Worth Rs.8000</li>
        </ul>
      </AccordionItem>
      <AccordionItem title="Doors & Windows">
        <ul>
          <li>Main Door – Flush Door With Veneer, Sal wood frame worth Rs.13000.</li>
          <li>Internal Doors - Membrane doors / Flush Door with Laminates up to Rs.8000.</li>
      ...
      <AccordionItem title="Flooring">
        <ul>
          <li>Living and Dining Flooring – Tiles of value up to Rs.50 per sqft</li>
          <li>Rooms and Kitchen Flooring – Tiles Rs.50 per sqft</li>
          <li>Balcony and Open Areas Flooring – Anti-skid tiles of value up to Rs.40 per sqft</li>
          <li>Staircase Flooring – Sadarahalli Granite of value up to Rs.70 per sqft</li>
          <li>Parking Tiles – Anti-skid tiles of value up to Rs.40 per sqft</li>
        </ul>
      </AccordionItem>
      ...
      <AccordionItem title="Miscellaneous">
        <ul>
          ...
          <li>Railing Grills – Basic MS Grills with Enamel Paint at Rs.110 per sqft</li>
        </ul>
      </AccordionItem>
    </div>
    </div>
