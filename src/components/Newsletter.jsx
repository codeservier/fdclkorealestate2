        ...
        <div className="px-6 lg:px-12">
          <div className="grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
            <div className="max-w-xl lg:max-w-lg ">
              ...
              <p className="mt-4 text-lg leading-8 text-gray-300">Stay up-to-date with our latest news and exclusive offers by subscribing to our newsletter.</p>
            ...
            <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
              <div className="flex flex-col items-start">
                ...
                <dd className="mt-2 leading-7 text-gray-300">Receive our weekly articles straight to your inbox and stay informed on the latest industry prices.</dd>
              </div>
              <div className="flex flex-col items-start">
                <div className="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
                ...
                <dd className="mt-2 leading-7 text-gray-300">We respect your privacy and promise no spam. You&apos;ll only receive valuable content and updates from us.</dd>
              </div>
            </dl>
          </div>
        </div>
        <svg className="absolute left-1/2 top-0 -z-10 h-[42.375rem] -translate-x-1/2 blur-3xl xl:-top-6" viewBox="0 0 1155 678" fill="none">
          <path
